...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="<?php echo base_url(); ?>assest/dist/img/logo.png" alt="AdminLTELogo" height="80" width="80">
  </div>

  <!-- Navbar -->
  <nav class="main-header navbar navbar-expand" style="background-color: #1891d7;">
    <!-- Left navbar links -->
    <ul class="navbar-nav">
     <li class="nav-item d-none d-sm-inline-block">
        <a class="nav-link" style="color: #fff; font-size: 21px;"> Portal Of Interview</a>
      </li>
      </ul>
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <div class="container">
        <a href="<?php echo base_url(); ?>Login/logout" class="btn btn-default btn-lg">
